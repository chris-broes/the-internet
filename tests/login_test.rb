...
caps1["tunnelIdentifier"] = ENV['TRAVIS_BUILD_NUMBER']
...
caps2["tunnelIdentifier"] = ENV['TRAVIS_BUILD_NUMBER']
...
caps3["tunnelIdentifier"] = ENV['TRAVIS_BUILD_NUMBER']
...
caps4["tunnelIdentifier"] = ENV['TRAVIS_BUILD_NUMBER']
